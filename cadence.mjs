...
function warmBody(n, p) {
  ...
  if (n === 1) {
    ...
    return legal
      ? `${dr},\n\nThe usual assumption is that this means dispensing from the office. It does not. Pennsylvania has prohibited that for workers' compensation since 2014, and nothing here changes it.\n\nThe scripts are filled and shipped by the pharmacy. Your staff touch none of it.\n\n${link(t, 'program')}\n\nBest,`
...
const WARM_SUBJECT = { 1: 'This is not office dispensing', 2: 'Most start with one office', 3: 'Leaving this with you' };
const HOT_SUBJECT = { 1: 'Fifteen minutes?', 2: 'What actually changes for the practice', 3: 'Leaving this with you' };
const WARM_OBJ = { 1: 'differentiation', 2: 'meeting', 3: 'breakup' };
...
const SUBJECTS = {
  ...
  2: "Where that pharmacy revenue goes today",
