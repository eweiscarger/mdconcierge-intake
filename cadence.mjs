...
const COLD_BODIES = {
  ...
  // Eric's own wording, 21 Sep 2026, replacing the earlier touch 2 in full. The opt-out he wrote at
  // the end of it is NOT included here: COLD_OPTOUT already prints below the signature, and putting
  // it in the body too would send every touch 2 with two opt-outs.
  "2": "Industry data shows up to 30% of work comp patients have trouble getting their prescriptions filled at retail pharmacies. Some of your patients are probably dealing with this right now, and you may not even know it.\n\nOn the scripts that do get filled, the money goes to PBMs that have nothing to do with patient care. Just three insurer-owned PBMs handle 79% of U.S. prescription claims. In work comp, prescription spend averages $2,262 per claim (Workers Compensation Research Institute). You do all the work and see none of it.\n\nA mail-order pharmacy program like MDRx fixes both. Your staff simply sends the Rx to our in-network pharmacy partner through your EHR, and your patients get their meds delivered to their homes overnight at no cost. As of June, the PA Supreme Court ruled the Workers' Comp Act's anti-referral provision doesn't apply to prescription drugs (700 Pharmacy, 6/16/26), so you or your practice can now generate revenue from those prescriptions if you wish, instead of it all going to the PBMs.\n\nJust reply interested and I will send you more info on the ruling and our program. I am also happy to do a call or stop by with coffee at your request.",
